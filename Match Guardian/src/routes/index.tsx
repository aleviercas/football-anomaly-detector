...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Football Anomaly Detector — análisis de amaños en partidos" },
      { name: "description", content: "Detecta anomalías estadísticas en partidos de fútbol pasados usando 8 algoritmos: Isolation Forest, LOF, análisis bayesiano, patrones de amaño, temporal y más." },
      { property: "og:title", content: "Football Anomaly Detector" },
