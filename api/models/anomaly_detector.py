...
class AdvancedAnomalyDetector:
    """
    Sistema avanzado de detección de anomalías en partidos de fútbol.
    Versión ligera compatible con Vercel y sin dependencias pesadas.
    """
    ...
    def _calculate_statistical_anomaly(self, match_data, league='premier_league'):
        """
        An�lisis estad�stico avanzado usando m�ltiples m�tricas
        """
        reasons = []
        statistical_scores = {}
        ...
        for feature, stats_data in league_stats.items():
            if feature in match_data:
                ...
                # 2. Percentil aproximado usando distribución normal estándar
    ...
    def _detect_suspicious_patterns(self, match_data):
        """
        Detecci�n de patrones espec�ficos de posible amaño
        """
        patterns = []
        pattern_score = 0
            ...
            if total_goals > 0:
                ...
                if late_ratio > 0.6 and late_goals >= 2:
                    patterns.append({
                        ...
                        'detail': f'{late_goals} de {total_goals} goles en �ltimos 15 minutos'
                    })
                    pattern_score += 0.25
        ...
        if 'goals_last_15_min' in match_data and 'home_goals' in match_data and 'away_goals' in match_data:
            ...
            if late >= 3 and abs(home - away) <= 1:
                patterns.append({
                    ...
                    'severity': 0.9,
                    'description': 'M�ltiples goles tard�os en partido igualado',
                    'detail': f'Marcador final: {home}-{away}, Goles 75\'+: {late}'
                })
                pattern_score += 0.3
        
        # 3. Patr�n de penales m�ltiples
        if 'penalties' in match_data:
            ...
            if penalties >= 3:
                patterns.append({
                    ...
                    'severity': 0.95,
                    'description': f'N�mero extremo de penales: {penalties}',
                ...
                patterns.append({
                    'type': 'multiple_penalties',
                    'severity': 0.6,
                    'description': f'M�ltiples penales: {penalties}',
        ...
        if 'red_cards' in match_data:
            ...
            if red_cards >= 3:
                patterns.append({
                    ...
                    'severity': 0.9,
                    'description': f'N�mero extremo de expulsiones: {red_cards}',
                ...
                patterns.append({
                    'type': 'multiple_red_cards',
                    'severity': 0.65,
                    'description': f'M�ltiples expulsiones: {red_cards}',
        ...
        if 'home_goals' in match_data and 'away_goals' in match_data:
            ...
            if total_goals >= 8:
                patterns.append({
                    ...
                    'severity': 0.7,
                    'description': f'N�mero extremo de goles: {total_goals}',
    ...
    def analyze_match(self, match_data, league='premier_league'):
        ...
        if probability >= 80:
            ...
            risk_color = "#d32f2f"
            confidence = "Muy Alta"
            recommendation = "INVESTIGACI INMEDIATA REQUERIDA - Posible amaño"
        elif probability >= 65:
            risk_level = "MUY ALTO"
            risk_color = "#f44336"
            confidence = "Alta"
